...
function AdminDashboardHeader({ HEIGHT = "h-20" }) {
  ...
  return (
    <div className={`${HEIGHT} bg-linear-to-tr from-white via-white to-fuchsia-200 sticky top-0 z-51  border-b border-violet-500/50`}>
                ...
                <div className="flex justify-between items-center gap-3">
                  <div className="">
                    <ImageBox
                      ...
                      className="size-10 rounded-full overflow-hidden border-4 border-violet-600"
            ...
            >
              <div className="py-3">
                <div className="p-3 bg-white rounded-lg space-y-3 shadow-lg">
                  <Link href={`/dashboard/user/profile`} className="flex gap-3 items-center text-gray-500 px-2 py-2 hover:bg-blue-950 hover:text-white rounded">
                    <div>
                  ...
                  <div onClick={appUserlogout} className="flex gap-3 items-center text-gray-500 px-2 py-2 hover:bg-blue-950 hover:text-white rounded cursor-pointer">
                    <div>
