...
function ToolAccessTranslation({ show, setShow }: any) {
  ...
  const mainData: any = {
    [pageName]: "Access Premium Tools",
    unlock: "Unlock Your Premium Tools in 3 Simple Steps",
    our_custom: "Our custom desktop app ensures a secure, lightning-fast connection to all your favorite platforms without manual logins.",
    download_the: "Download the XToolVip App",
    step1: "Step 1.",
    our_secure: "Our secure Windows application provides a dedicated, anti-detect environment to keep your tool sessions stable and private.",
    download_for: "Download for Windows (x64)",
    log_in_to: "Log In to Your Account",
    step2: "Step 2.",
    launch_the: "Launch the app and sign in using your XToolVip credentials. This instantly syncs your active subscriptions and prepares your secure proxy tunnel.",
    launch_create: "Launch & Create",
    step3: "Step 3.",
    navigate_to:
      "Navigate to your dashboard and click on any premium tool. Our app automatically injects the secure session—no passwords required. You are ready to work!",
  };
...
export default ToolAccessTranslation;
