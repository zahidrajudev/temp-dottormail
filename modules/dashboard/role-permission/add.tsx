...
import RoleAddTranslation from "./translations/add";
import Select from "@/modules/global/input/select";

function RolePermissionAddPage() {
  ...
  const handleCreate = () => {
    let url = "v1/dashboard/role-permission/create";
    let data = {
      name,
    ...
    if (checkErrors({ name, selectedPermissions }, setErrors, false)) {
      return;
    }
  ...
  const getInitialData = async () => {
    setLoading(true);
    let url = "v1/dashboard/role-permission/permissions";
    await api
      .post(url)
      .then((res) => {
        setLoading(false);
  ...
  const permissionList = [
    {
      ...
      permissions: [
        ...
        {
          id: "dashboard.author",
          name: "Author Dashboard Analytics",
        ...
        {
          id: "dashboard.client",
          name: "Client Dashboard Analytics",
  ...
  // {
  //   name: "ABCD Permissions",
  //   permissions: [
  //     {
  //       id: "base.view",
  //       name: "View only own ABCD list",
  //       permission: <Switch value={selectedPermissions.includes("base.view")} onChange={(val) => handlePermissionSelection("base.view")} />,
  //     },
  //     {
  //       id: "base.view-all",
  //       name: "View all ABCD list",
  //       permission: <Switch value={selectedPermissions.includes("base.view-all")} onChange={(val) => handlePermissionSelection("base.view-all")} />,
  //     },
  //     {
  //       id: "base.create",
  //       name: "Create new ABCD",
  //       permission: <Switch value={selectedPermissions.includes("base.create")} onChange={(val) => handlePermissionSelection("base.create")} />,
  //     },
  //     {
  //       id: "base.edit",
  //       name: "Edit only own ABCDs",
  //       permission: <Switch value={selectedPermissions.includes("base.edit")} onChange={(val) => handlePermissionSelection("base.edit")} />,
  //     },
  //     {
  //       id: "base.edit-all",
  //       name: "Edit all existing ABCDs",
  //       permission: <Switch value={selectedPermissions.includes("base.edit-all")} onChange={(val) => handlePermissionSelection("base.edit-all")} />,
  //     },
  //     {
  //       id: "base.delete",
  //       name: "Delete only own ABCD",
  //       permission: <Switch value={selectedPermissions.includes("base.delete")} onChange={(val) => handlePermissionSelection("base.delete")} />,
  //     },
  //     {
  //       id: "base.delete-all",
  //       name: "Delete all existing ABCD",
  //       permission: <Switch value={selectedPermissions.includes("base.delete-all")} onChange={(val) => handlePermissionSelection("base.delete-all")} />,
  //     },
  //   ],
  // },
  ...
  return (
    <>
      ...
      <Section permission={hasPermission("role.create")} loading={loading} className="bg-white p-8 border border-gray-200 rounded-lg space-y-10">
      ...
      <RoleAddTranslation show={showTranslation} setShow={setShowTranslation} />
    </>
  );
}
