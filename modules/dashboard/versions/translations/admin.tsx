...
function AdminDashboardTranslation({ show, setShow }: any) {
  ...
  const mainData: any = {
    ...
    quarter: "Quarter",
    year: "Year",
    data_use_overview: "Data Use Overview",
    ...
    total_master_accounts: "Total Master Accounts",
    ...
    total_media_folders: "Total Media Folders",
    total_payment_gateways: "Total Payment Gateways",
  ...
  return (
    <Modal show={show} setShow={setShow} maxWidth="w-[90%]">
      <Section fullWidth permission={hasPermission("translation.create")} loading={loading} className=" px-6 py-10 space-y-6">
        {/* 🔥 TOP ACTION BAR */}
...
export default AdminDashboardTranslation;
