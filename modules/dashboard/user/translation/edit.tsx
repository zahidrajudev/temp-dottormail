...
function UserEditTranslation({ show, setShow }: any) {
  const pageName = "user_edit";
  ...
  const mainData: any = {
    ...
    no_whitespace_allowed: "No whitespace allowed and Username must be unique.",
    example_user123: "Example: user123",
    phone: "Phone",
    enter_phone_number: "Enter Phone Number",
    please_add_your: "Please add your country code.",
    active: "Active",
    inactive: "Inactive",
    ...
    add_now: "Add Now",
    do_you_want: "Do you want to change the password?",
  };
...
export default UserEditTranslation;
