...
import UserEditTranslation from "./translation/edit";
    ...
    <>
      ...
      <Section permission={hasPermission("user.edit")} loading={loading} className="bg-white p-8 border border-gray-200 rounded-lg space-y-10">
        ...
        <div className="flex flex-wrap justify-between items-center">
          <div>{t("do_you_want")}</div>
          <div className="">
            <Switch value={passwordChange} onChange={setPasswordChange} />
          </div>
        </div>
        {passwordChange && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
      ...
      <UserEditTranslation show={showTranslation} setShow={setShowTranslation} />
    </>
  );
}
