...
function PackageEditTranslation({ show, setShow }: any) {
  ...
  const mainData: any = {
    ...
    change_price: "Do you want to change the price?",
    move_customers: "Do you want to move all existing customers to this new price to apply next bill?",
  };
...
export default PackageEditTranslation;
