...
function MediaTrashFoldersTranslation({ show, setShow }: any) {
  ...
  const mainData: any = {
    media_trash_folders: "Media Trash Folders",
    all_trash_folders: "All Trash Folders",
    restore: "Restore",
...
export default MediaTrashFoldersTranslation;
