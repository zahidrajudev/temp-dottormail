...
function MediaGalleryTranslation({ show, setShow }: any) {
  ...
  const mainData: any = {
    ...
    upload: "Upload",
    remove: "Remove",
    upload_from_disk: "Upload From Disk",
    ...
    list_of_valid_links: "List of Valid Image Links | Seperate the Each Links by 'Press Enter",
...
export default MediaGalleryTranslation;
