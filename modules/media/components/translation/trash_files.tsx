...
function MediaTrashFilesTranslation({ show, setShow }: any) {
  ...
  const mainData: any = {
    media_trash_files: "Media Trash Files",
    all_trash_files: "All Trash Files",
    restore: "Restore",
...
export default MediaTrashFilesTranslation;
