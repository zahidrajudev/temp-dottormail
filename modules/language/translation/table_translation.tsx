...
function DashboardTableTranslation() {
  ...
  const mainData: any = {
    manage_table_translations: "Manage Table Translations",
    actions: "Actions",
    mark_all: "Mark All",
...
export default DashboardTableTranslation;
