...
function DashboardPaginationTranslation() {
  ...
  const mainData: any = {
    manage_pagination_translations: "Manage Pagination Translations",
    previous: "Previous",
    next: "Next",
  };
  ...
  return (
    <>
      <div onClick={() => setShow(true)} className="w-max p-5 rounded hover:bg-violet-600 hover:text-white bg-white font-semibold hover:scale-105 duration-500 cursor-pointer">
        {t("manage_pagination_translations")}
      </div>
...
export default DashboardPaginationTranslation;
