...
const CheckoutPage = () => {
  ...
  return (
    <Section permission={appAuth} fullWidth className="bg-linear-to-b from-slate-950 via-violet-950 to-fuchsia-950 relative overflow-hidden py-30 -mt-20">
      {/* Background Effects */}
      <div className="absolute inset-0 bg-[linear-gradient(rgba(139,92,246,0.08)_1px,transparent_1px),linear-gradient(90deg,rgba(139,92,246,0.08)_1px,transparent_1px)] bg-size-[60px_60px]"></div>
      <div className="absolute top-20 right-20 w-96 h-96 bg-fuchsia-500/10 rounded-full blur-3xl animate-pulse"></div>
      <div className="absolute bottom-20 left-20 w-96 h-96 bg-violet-500/10 rounded-full blur-3xl animate-pulse delay-500"></div>

      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {/* Header */}
        {JSON.stringify(setMainData)}
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-white/10 backdrop-blur-xl rounded-full border border-white/20 mb-6">
            <SvgIcon name="shopping_cart" className="w-5 h-5 text-fuchsia-400" />
            <span className="text-sm font-semibold text-white uppercase tracking-wider">Checkout</span>
          </div>
          <h1 className="text-3xl sm:text-4xl font-black text-white">
            Complete Your <span className="bg-linear-to-r from-fuchsia-400 via-pink-400 to-violet-400 bg-clip-text text-transparent">Purchase</span>
          </h1>
          ...
          {steps.map((step, index) => (
            <React.Fragment key={step.key}>
              ...
              <button
                ...
                className={`group relative flex flex-col items-center gap-2 focus:outline-none ${index < steps.length - 1 ? "sm:flex-row sm:gap-3" : ""}`}
              >
                <div
                  className={`relative z-10 flex items-center justify-center w-12 h-12 rounded-full border-2 transition-all duration-300 ${
                    activeTab === step.key
                      ? "border-fuchsia-400 bg-fuchsia-500/20 text-fuchsia-400 shadow-lg shadow-fuchsia-500/30"
                      : activeTab === "billing" && step.key === "billing"
                        ? "border-violet-400 bg-violet-500/20 text-violet-400 shadow-lg shadow-violet-500/30"
                ...
                <span
                  className={`text-xs font-medium mt-2 transition-colors ${
                    activeTab === step.key ? "text-fuchsia-400" : activeTab === "billing" && step.key === "billing" ? "text-violet-400" : "text-white/40"
                  }`}
                >
                  {step.label}
                </span>
                  ...
                  <div
                    className={`h-full bg-linear-to-r rounded-full transition-all duration-500 ${
                      index === 0 && activeTab !== "summary"
                        ? "bg-linear-to-r from-fuchsia-400 to-violet-400 w-full"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-4">
                <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                  <SvgIcon name="receipt_long" className="w-6 h-6 text-violet-400" />
                  Order Items
                </h2>
                ...
                <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-5 border border-white/20">
                  <div className="flex gap-3">
                    <input
                      ...
                      className="flex-1 bg-white/10 border border-white/20 rounded-xl px-5 py-3.5 text-white placeholder:text-white/30 focus:outline-none focus:border-fuchsia-400/50 focus:ring-1 focus:ring-fuchsia-400/30 transition-all"
                    />
                    <button
                      ...
                      className={`px-6 py-3.5 rounded-xl font-semibold text-sm whitespace-nowrap transition-all ${
                        appliedPromo
                          ...
                          : "bg-linear-to-r from-violet-600 to-fuchsia-600 text-white hover:from-violet-500 hover:to-fuchsia-500 shadow-lg shadow-violet-500/20"
                      }`}
                    >
              ...
              <div className="space-y-4 flex flex-col">
                ...
                <div className="flex-1 bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20 space-y-4">
                  ...
                  <div className="border-t border-white/10 pt-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-white font-bold text-lg bg-linear-to-r from-fuchsia-400 to-violet-400 bg-clip-text">
                ...
                <Button
                  ...
                  className="w-full bg-linear-to-r from-fuchsia-600 to-violet-600 text-white font-bold text-lg shadow-2xl shadow-fuchsia-500/30 hover:shadow-fuchsia-500/50 hover:scale-[1.02] transition-all duration-300"
                  border="rounded-full"
                  px="px-10"
                  py="py-3.5"
                  showIcon
              ...
              <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        placeholder="John"
                        className="w-full bg-white/10 border border-white/20 rounded-xl px-5 py-3.5 text-white placeholder:text-white/30 focus:outline-none focus:border-fuchsia-400/50 focus:ring-1 focus:ring-fuchsia-400/30 transition-all"
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <select
                        ...
                        className="w-full bg-white/10 border border-white/20 rounded-xl px-5 py-3.5 text-white placeholder:text-white/30 focus:outline-none focus:border-fuchsia-400/50 focus:ring-1 focus:ring-fuchsia-400/30 transition-all appearance-none cursor-pointer"
                      >
                ...
                <div className="flex justify-between items-center pt-4">
                  ...
                  <Button
                    ...
                    className="bg-linear-to-r from-fuchsia-600 to-violet-600 text-white font-bold shadow-lg shadow-fuchsia-500/30 hover:shadow-fuchsia-500/50"
                    border="rounded-full"
                    px="px-10"
                    py="py-3.5"
                    showIcon
                    ...
                    mainData.map((item) => (
                      <div key={item.id} className="flex justify-between items-center">
                        <div className="flex items-center gap-3">
                          <div className="w-4 h-4 rounded-full bg-linear-to-br from-violet-500 to-fuchsia-500 shrink-0"></div>
                  ...
                  <div className="border-t border-white/10 pt-3 mt-2">
                    ...
                    <div className="border-t border-white/10 pt-3 mt-2">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-white font-bold bg-linear-to-r from-fuchsia-400 to-violet-400 bg-clip-text">
                          {formatPrice(calculateSubtotal(mainData))}
                        </span>
                      </div>
                    </div>
        ...
        {activeTab === "payment" && (
          <div>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-6">
                <h2 className="text-xl font-bold text-white mb-2 flex items-center gap-2">
                  <SvgIcon name="credit_card" className="w-6 h-6 text-violet-400" />
                  Payment Method
                </h2>
                <p className="text-violet-300/60 text-sm mb-6">Choose your preferred payment method and enter your details.</p>
                ...
                {/* Card Form */}
                <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20 space-y-5">
                  {paymentMethod === "stripe" && <StripePaymentForm item_id={itemID} currency_code={appSelectedCurrency?.code ?? ""} />}
                  {paymentMethod === "paypal" && (
                    <div className="text-center py-10">
                      <SvgIcon name="paypal" className="w-16 h-16 mx-auto mb-4" filled />
                      <p className="text-violet-300 text-sm">You will be redirected to PayPal to complete your payment.</p>
                    </div>
                  )}
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <label htmlFor="terms" className="text-sm text-violet-300/70">
                    I agree to the{" "}
                ...
                <div className="flex justify-between items-center pt-6">
                  ...
                  <Button
                    ...
                    className="bg-linear-to-r from-fuchsia-600 to-violet-600 text-white font-bold text-lg shadow-2xl shadow-fuchsia-500/40 hover:shadow-fuchsia-500/60 hover:scale-[1.02] transition-all duration-300 disabled:opacity-75"
                    border="rounded-full"
                    px="px-12"
                    py="py-3.5"
                    showIcon
              ...
              <div className="space-y-4 flex flex-col">
                ...
                <div className="flex-1 bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20 space-y-4">
                    ...
                    mainData.map((item) => (
                      <div key={item.id} className="flex gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-violet-400 text-xs">Qty: 1</p>
                        </div>
                  ...
                  <div className="border-t border-white/10 pt-4 space-y-2">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-violet-300/80 text-sm">Tax (0%)</span>
                    ...
                    <div className="border-t border-white/10 pt-3">
                      <div className="flex justify-between items-center">
                        <span className="text-white font-bold">Total</span>
                        <span className="text-white font-bold bg-linear-to-r from-fuchsia-400 to-violet-400 bg-clip-text text-lg">
                          {formatPrice(calculateSubtotal(mainData))}
                        </span>
                      </div>
                    </div>
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-violet-400 text-xs">256-bit SSL encryption</p>
                    </div>
                  </div>
                </div>
              </div>
